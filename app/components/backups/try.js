...
const CardDesc = ({ children }) => (
  <p className="text-[15px] md:max-w-[240px] font-light w-full text-left">
    {children}
  </p>
);
...
export default function Expertise() {
  return (
    <section
      ...
      {/* Heading */}
      <p className="text-5xl md:text-7xl lg:text-8xl xl:text-[9rem] font-black text-center text-neutral-600">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 lg:grid-rows-2 gap-4 w-full rounded-3xl">
        ...
        <Card
          ...
          className=" col-span-2 row-span-2 bg-none md:bg-[url('/hero/phonetop.png')] md:bg-no-repeat md:bg-right-bottom md:bg-[length:45%_auto]"
        />
        ...
        <Card
          ...
          className=" col-span-2 row-span-2 lg:col-start-1 lg:row-start-2 bg-none md:bg-[url('/hero/pc.png')] md:bg-no-repeat md:bg-right-center md:bg-[length:70%_auto]"
        />
