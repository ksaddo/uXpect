...
export default function ButtonOrange({ children = "Click Me" }) {
  return (
    <button
      className="group relative w-fit text-sm lg:text-base px-5 py-2 lg:px-6 lg:py-3 rounded-full bg-orange-700
