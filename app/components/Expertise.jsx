...
const Card = ({ icon, title, desc, className = "" }) => (
  <div
    className={`relative overflow-hidden rounded-3xl border border-dashed border-neutral-700 bg-black/30 backdrop-blur-sm transition-all duration-300 hover:border-solid hover:scale-[1.02] ${className}`}>
    <div className="relative z-10 px-4 py-3 md:px-7 md:py-9 rounded-3xl h-full flex md:flex-col justify-center gap-2 md:gap-4 text-left flex-wrap md:flex-nowrap">
      <CardIcon icon={icon} />
...
export default function Expertise() {
  return (
    <section
      className=" px-4 md:px-[30px] xl:px-[50px] 2xl:px-[110px]"
