...
export default function GetWebsite2() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-around px-4 md:px-[30px] xl:px-[50px] 2xl:px-[110px]">
      {/* Hero Section */}
      ...
      <section className="mx-auto  max-w-5xl">
        <div className="grid md:grid-cols-3 gap-6">
          {steps.map((step, i) => (
            <div
              key={i}
              className="border border-dashed border-gray-800 rounded-2xl p-6 flex flex-col gap-3 hover:border-gray-600 transition ease-in-out transform hover:scale-102">
              <span className="flex justify-between items-center text-white group-hover:text-[var(--primary)]">
                ...
                <p className="mb-4 border rounded-full p-2 ">{step.icon}</p>
              </span>
